...
void llenarMatrizex(char *nombre, int matriz[3][3]) {
    int x, y;
    gotoxy(x + 5,  y);
    printf("%s", nombre);
    printf("Nombre de la matriz: %s\n", nombre);
...
void imprimirmarcoex(int x, int y){
    for (int i = 0; i < 3; i++) {
        gotoxy(x, y + 1 + i);     
        printf("*");
...
void imprimirmatrizex(int x, int y, char *nombre, int matriz[3][3]) {
    gotoxy(x + 5, y);
    printf("%s", nombre);
...
void sumarMatrizex(int matriz1[3][3], int matriz2[3][3], int matrizr[3][3]) {
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
            matrizr[i][j] = matriz1[i][j] + matriz2[i][j];
        }
...
void restaMatrizex(int matriz1[3][3], int matriz2[3][3], int matrizr[3][3]) {
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
            matrizr[i][j] = matriz1[i][j] - matriz2[i][j];
        }
...
void escalarMatrizex(int matriz1[3][3], int escalar, int matrizr[3][3]) {
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
...
int determinanteex(int MatrizA[3][3]) {
    int MatrizExp[3][5], determinante = 0;
    int i, j;
...
limpiarpantalla();
setColor("\033[7;31m");
llenarMatrizex("Matriz A", matriza);
llenarMatrizex("Matriz B", matrizb);
limpiarpantalla();
...
switch(opc){
        case 1: 
            ...
            setColor("\033[0m");
            printf ("%s\n", "Ha seleccionado suma");
            sumarMatrizex(matriza, matrizb, matrizsuma);
            limpiarpantalla();
            setColor("\033[7;32m");
            imprimirmatrizex(5, 2, "Matriz A", matriza);
            setColor("\033[7;35m");
            imprimirmatrizex(30, 2, "Matriz B", matrizb);
            setColor("\033[4;33m");
            imprimirmatrizex(55, 2, "A + B", matrizsuma);
        ...
        case 2:
            ...
            setColor("\033[0m");
            printf ("%s\n", "Ha seleccionado resta");
           restaMatrizex(matriza, matrizb, matrizresta);
           limpiarpantalla();
           setColor("\033[7;32m");
           imprimirmatrizex(5, 2, "Matriz A", matriza);
           setColor("\033[7;35m");
           imprimirmatrizex(30, 2, "Matriz B", matrizb);
           setColor("\033[4;33m");
           imprimirmatrizex(80, 2, "A - B", matrizresta);
    ...
    scanf("%d", &escalar);
            ...
            setColor("\033[0m");
            printf ("%s\n", "Ha seleccionado multiplicación");
            escalarMatrizex(matriza, escalar, matrizescalar);
            setColor("\033[7;32m");
            imprimirmatrizex(5, 2, "Matriz A", matriza);
            setColor("\033[7;35m");
            imprimirmatrizex(30, 2, "Matriz B", matrizb);
            setColor("\033[4;33m");
            imprimirmatrizex(105, 2, "Escalar por A", matrizescalar);
            break;  
        ...
        gotoxy(5, 10);
        int det = determinanteex(matriza);
...
int main() {
    ...
    switch(opc) {
        ...
        case 72:
        printf("Ha seleccionado el Programa Grafica de barras\n");
        programa72();
        break;

        case 73:
        printf("Ha seleccionado el Programa Examen\n");
        programa73();
        break;
